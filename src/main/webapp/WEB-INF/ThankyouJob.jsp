	...
	<div class="container">
		<div class="row">
			...
			<div class="title text-center wow fadeIn" data-wow-duration="500ms">
				<h2>Thank <span class="color">You</span></h2>
				<div class="border"></div>
			</div>
			
			<h2>you have successfully applied for the job now the HR will contact you soon.</h2>
			<!-- /section title -->
			<a class="btn btn-transparent" href="/member"><span class="color">Back to profile</span></a>
