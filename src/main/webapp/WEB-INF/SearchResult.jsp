...
<tr><td>${arvse.userId}</td><td>${arvse.userName}</td><td>${arvse.password}</td><td>${arvse.firstname}</td><td>${arvse.lastname}</td>
<td>${arvse.address}</td><td>${arvse.email}</td><td>${arvse.phone}</td>
<td ><a class="btn btn-transparent btn-block" href="update/${arvse.userId}">UPDATE</a></td>
<td><a class="btn btn-transparent" href="deletel">Delete Member</a></td></tr>
<%-- </dd:forEach> --%>
