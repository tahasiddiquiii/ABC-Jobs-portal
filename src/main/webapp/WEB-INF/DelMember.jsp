...
<body>
	<!-- section title -->
			<div class="title text-center wow fadeIn" data-wow-duration="500ms">
				<h2>Delete <span class="color">Member</span></h2>
...
<input class="btn-transparent btn-block" placeholder="select a member id" type="text" required="required" name="userId" />
<br>
<br>
<input type="submit" value="delete member's details" class="btn btn-transparent " >
