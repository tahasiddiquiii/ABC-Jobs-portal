...
<section id="contact-us" class="contact-us section-bg">
	...
	<!-- Contact Form -->
			...
			<jf:form action="/addjobseeker" method="Post" modelAttribute="job">
			
		
			
		    <div class="form-group">
			<jf:input path="jobId" placeholder="Job id" class="form-control" required="required" readonly="true" type="hidden"/>
			</div>
			
		    <div class="form-group">
		    <label>Job Title</label>
			<jf:input path="jobtitle" placeholder="Job title" class="form-control" required="required" readonly="true" />
			</div>
			
			<div class="form-group">
			<label>Company Name</label>
			<jf:input path="company" type="text" placeholder="company name" class="form-control" required="required" readonly="true"/>
			</div>
			
			<div class="form-group">
			<label>Job Description</label>
			<jf:input path="jobdescription" placeholder="job description" class="form-control" required="required" readonly="true" />
			</div>
			
			
			<div id="cf-submit">
			<input type="submit" value="Apply job" class="btn btn-transparent btn-block" >
			</div>
			</jf:form>
