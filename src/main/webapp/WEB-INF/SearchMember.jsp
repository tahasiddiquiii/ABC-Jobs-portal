...
<body>
	<!-- section title -->
			<div class="title text-center wow fadeIn" data-wow-duration="500ms">
				<h2>Search <span class="color">Member</span></h2>
				<div class="border"></div>
			</div>
			<!-- /section title -->
<div class="col-md-4 col-md-offset-4">
<sf:form action="/sear" method="post" modelAttribute="searchd" >
<sf:input path="userId" class="btn-transparent btn-block" placeholder="Search User ID" type="search" required="required"/>
<br>
<br>
