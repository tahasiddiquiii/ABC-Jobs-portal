	...
	<div class="container">
		<div class="row">
			...
			<div class="title text-center wow fadeIn" data-wow-duration="500ms">
				<h2>Update Member's <span class="color">Details</span></h2>
...
<input type="text" name="userId" class="form-control" value="${updatemember.userId}" readonly="true"/>
</div>

 <div class="form-group">
<label>User Name</label>
<input type="text" name="userName" class="form-control" value="${updatemember.userName}" />
</div>

 <div class="form-group">
<label>Password</label>
<input type="password" name="password" class="form-control" value="${updatemember.password}" readonly="true" />
</div>

 <div class="form-group">
<label>First Name</label>
<input type="text" name="firstname" class="form-control" value="${updatemember.firstname}" />
</div>

 <div class="form-group">
<label>Last Name</label>
<input type="text" name="lastname" class="form-control" value="${updatemember.lastname}" />
</div>

 <div class="form-group">
<label>Address</label>
<input type="text" name="address" class="form-control" value="${updatemember.address}" />
</div>

 <div class="form-group">
<label>Email</label>
<input type="text" name="email" class="form-control" value="${updatemember.email}" />
</div>

 <div class="form-group">
<label>Phone</label>
<input type="text" name="phone" class="form-control" value="${updatemember.phone}" />
</div>

 <div class="form-group">
<input type="submit" class="btn btn-transparent btn-block" value="Update" />
</div>
