...
<section id="contact-us" class="contact-us section-bg">
	<div class="container">
		<div class="row">
			...
			<div class="title text-center wow fadeIn" data-wow-duration="500ms">
				<h2>Register <span class="color">Now</span></h2>
	...
	<!-- Contact Form -->
			...
			<sf:form action="/addMember" method="post" modelAttribute="taha">
			
		
			
		    <div class="form-group">
			<sf:input path="userName" placeholder="Your User Name" class="form-control" required="required" />
			</div>
			
			<div class="form-group">
			<sf:input path="password" type="password" placeholder="Your Password" class="form-control" required="required"/>
			</div>
			
			<div class="form-group">
			<sf:input path="firstname" placeholder="Your First Name" class="form-control" required="required"/>
			</div>
			
			<div class="form-group">
			<sf:input path="lastname" placeholder="Your Last Name" class="form-control" required="required"/>
			</div>
			
			<div class="form-group">
			<sf:input path="address" placeholder="Your Address" class="form-control" required="required"/>
			</div>
			
			<div class="form-group">
			<sf:input path="email" type="email" placeholder="Your Email" class="form-control" required="required"/>
			</div>
			
			<div class="form-group">
			<sf:input path="phone" type="number" placeholder="Your Phone Number" class="form-control" required="required"/>
			</div>
			
			<div id="cf-submit">
			<input type="submit" value="Register" class="btn btn-transparent btn-block" >
			</div>
			</sf:form>
