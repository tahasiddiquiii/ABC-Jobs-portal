	...
	<div class="container">
		<div class="row">
			...
			<div class="title text-center wow fadeIn" data-wow-duration="500ms">
				<h2>Member's <span class="color">Details</span></h2>
...
<tr>
<dd:forEach var="lear" items="${learnerinfo}">
<tr><td>${lear.userId}</td><td>${lear.userName}</td><td>${lear.password}</td><td>${lear.firstname}</td><td>${lear.lastname}</td><td>${lear.address}</td><td>${lear.email}</td><td>${lear.phone}</td>
<td ><a class="btn btn-transparent btn-block" href="update/${lear.userId}">UPDATE</a></td>
<td><a class="btn btn-transparent" href="deletel">Delete Member</a></td>
